    ...
    private static function getSubjectQuestions(string $key): array
    {
        ...
        self::$subjectQuestionBanks = [
            ...
            'physics' => [
                ...
                ['question' => 'When a ray of light passes from air to water, it bends:', 'A' => 'Away from the normal', 'B' => 'Towards the normal', 'C' => 'In a straight line', 'D' => 'Backwards', 'answer' => 'B', 'topic' => 'refraction'],
            ...
            'chemistry' => [
                ...
                ['question' => 'What is a flame?', 'A' => 'A solid fuel', 'B' => 'A burning gas or vapor that produces light and heat', 'C' => 'A type of liquid fuel', 'D' => 'An electrical discharge', 'answer' => 'B', 'topic' => 'flame'],
                ...
                ['question' => 'What condition produces a luminous flame in a Bunsen burner?', 'A' => 'Excess oxygen supply', 'B' => 'Insufficient oxygen supply', 'C' => 'High gas pressure', 'D' => 'Low gas pressure', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'The three zones of a Bunsen burner flame are:', 'A' => 'Top, middle, bottom', 'B' => 'Inner, middle, outer', 'C' => 'Red, yellow, blue', 'D' => 'Luminous, non-luminous, intermediate', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'What is the function of the air hole in a Bunsen burner?', 'A' => 'To release excess gas', 'B' => 'To control the amount of air entering', 'C' => 'To ignite the gas', 'D' => 'To cool the burner', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'Which of these fuels produces a flame when burned?', 'A' => 'Iron', 'B' => 'Charcoal', 'C' => 'Cooking gas', 'D' => 'Copper', 'answer' => 'C', 'topic' => 'flame'],
                ['question' => 'What color is a luminous flame?', 'A' => 'Blue', 'B' => 'Yellow', 'C' => 'Green', 'D' => 'Violet', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'A non-luminous flame is also called a:', 'A' => 'Smoky flame', 'B' => 'Oxidizing flame', 'C' => 'Reducing flame', 'D' => 'Cool flame', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'Which zone of a non-luminous flame has the highest temperature?', 'A' => 'Outer zone', 'B' => 'Middle zone', 'C' => 'Inner zone', 'D' => 'All zones are the same', 'answer' => 'A', 'topic' => 'flame'],
                ['question' => 'For complete combustion of a fuel to occur, there must be:', 'A' => 'Limited oxygen supply', 'B' => 'Sufficient oxygen supply', 'C' => 'High pressure', 'D' => 'Low temperature', 'answer' => 'B', 'topic' => 'combustion'],
                ['question' => 'Which gas is produced during incomplete combustion of a hydrocarbon?', 'A' => 'Carbon dioxide', 'B' => 'Carbon monoxide', 'C' => 'Oxygen', 'D' => 'Nitrogen', 'answer' => 'B', 'topic' => 'combustion'],
                ['question' => 'The products of complete combustion of a hydrocarbon are:', 'A' => 'Carbon and water', 'B' => 'Carbon dioxide and water', 'C' => 'Carbon monoxide and hydrogen', 'D' => 'Carbon and hydrogen', 'answer' => 'B', 'topic' => 'combustion'],
                ...
                ['question' => 'What happens to the temperature of a flame when the air hole is fully opened?', 'A' => 'It decreases', 'B' => 'It increases', 'C' => 'It stays the same', 'D' => 'It fluctuates', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'Which type of flame is suitable for heating in a laboratory?', 'A' => 'Luminous flame', 'B' => 'Non-luminous flame', 'C' => 'Both equally', 'D' => 'Neither', 'answer' => 'B', 'topic' => 'flame'],
                ['question' => 'What is produced when a candle burns?', 'A' => 'Only light', 'B' => 'Only heat', 'C' => 'Light, heat, carbon dioxide and water', 'D' => 'Only carbon dioxide', 'answer' => 'C', 'topic' => 'combustion'],
                ['question' => 'The function of the collar in a Bunsen burner is to:', 'A' => 'Hold the burner upright', 'B' => 'Control the gas flow', 'C' => 'Control the air supply', 'D' => 'Direct the flame', 'answer' => 'C', 'topic' => 'flame'],
            ],
