  ...
  resultContainer.innerHTML = `
    ...
    <div class="p-5 sm:p-6 bg-white border border-slate-200 rounded-2xl sm:rounded-3xl shadow-xs print-hidden slide-up">
      <div class="flex flex-wrap items-center gap-3">
        ...
        <button onclick="handlePrintResultSlip()" class="px-4 py-2.5 bg-blue-800 hover:bg-blue-700 text-white font-extrabold text-xs rounded-xl transition-all shadow-md flex items-center gap-2 cursor-pointer">
    ...
    <div class="p-5 sm:p-7 bg-white border border-slate-200 rounded-2xl sm:rounded-3xl shadow-sm space-y-6 print-hidden slide-up">
      ...
      <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-slate-200 mt-6">
        ...
        <button onclick="window.print()" class="px-4 py-2.5 bg-blue-800 hover:bg-blue-700 text-white font-extrabold text-xs rounded-xl transition-all shadow-md flex items-center gap-2 cursor-pointer">
